...
export function TableStatusDetail({ table, isLoading, actionLoading, handleAction }: TableStatusDetailProps) {
        ...
        <div className="w-full">
          {table.status === "Libre" && (
            <div className="grid grid-cols-2 gap-3 w-full">
              ...
              <LoadingButton 
                ...
                onClick={() => handleAction("Reservando")}
                isLoading={isLoading && actionLoading === "Reservando"}
              >
          ...
          {table.status === "Ocupada" && (
            <div className="flex gap-3 w-full">
              ...
              <LoadingButton 
                className="flex-2 bg-restaurante-primario hover:bg-restaurante-oscuro text-white rounded-2xl h-12 text-md font-bold shadow-lg shadow-restaurante-primario/20 transition-all hover:-translate-y-1"
